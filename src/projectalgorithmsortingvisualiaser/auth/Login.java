...
import projectalgorithmsortingvisualiaser.*;
...
// -----------------------------------------Initialize the contents of the frame.----------------------------------------------------
	...
	// Begin initialize()
		...
		txtUsernameEmail.setFont(new Font("Century Gothic", Font.BOLD, 14));
		...
		btnLogin.setFont(new Font("Century Gothic", Font.BOLD | Font.ITALIC, 17));
		...
		chckbxShowPassword.setFont(new Font("Century Gothic", Font.ITALIC, 13));
		...
		chckbxShowPassword.setBounds(275, 199, 140, 23);
		...
		btnSignUp.setFont(new Font("Century Gothic", Font.PLAIN, 13));
	...
	// Begin testMyLogin()
		...
		if ( ( (email.isEmpty()) && (passwd.isEmpty()) ) || ( (email.contains("Enter Username or Email")) && (passwd.contains("Enter Password")) ) )
			...
			if (!conn.hashmap.containsKey(email))
				...
				if (conn.hashmap.get(email).getPassword().equals(passwd)) {
					ConnToDB.user= conn.hashmap.get(email);
					this.secWind();
				}
				else
